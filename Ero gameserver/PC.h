...
{
	PC->ClientReturnToMainMenu(TEXT("This Gameserver was made by Marvelco Credits to him Join Ero OGFN discord:https://discord.gg/KdVw8MrR5g This gameserver is intended for private use with friends Not for projects if this is used in a project please report it in my discord server"));
}
